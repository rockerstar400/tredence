...
//                       Retail
//                     </Link>
//                     <Link to="/industrial/healthcare" className="hover:text-orange-500 block">
//                       Healthcare
//                     </Link>
...
//                     <Link to="/industries/life-sciences" className="hover:text-orange-500 block">
//                       Life Sciences
//                     </Link>
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[999] text-white bg-[#222] shadow-2xl font-sans">
      ...
      <div className="flex justify-end gap-5 text-[10px] font-bold px-12 py-2 opacity-70 tracking-widest border-b border-white/5">
        <a href="#" className="hover:text-orange-500">SIGMA AT A GLANCE</a>
        <a href="#" className="hover:text-orange-500">LATEST NEWS</a>
        <a href="#" className="hover:text-orange-500">EVENTS</a>
        <a href="#" className="hover:text-orange-500">WE'RE HIRING</a>
        <button className="bg-[#e84e0e] px-4 py-1 rounded-sm text-white font-bold ml-2">CONTACT US</button>
      </div>
    ...
    <div className="h-20 w-44 flex items-center justify-center p-2">
      ...
      />
             ...
             <div className="flex flex-col border-l border-white/20 pl-4">
                <h1 className="text-3xl font-black tracking-tighter leading-none italic group-hover:text-orange-500 transition-colors">SIGMA</h1>
        ...
        <div className="flex items-center gap-6 text-[13px] font-bold h-full">
          <ul className="flex gap-1 h-full">
            ...
            <li className="h-full flex items-center px-4 hover:text-orange-500 cursor-pointer">Partnerships</li>
          ...
          <Search size={20} className="cursor-pointer hover:text-orange-500 ml-4" />
        </div>
      </div>
    </nav>
  );
