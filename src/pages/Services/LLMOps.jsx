...
>
  ...
  <motion.div
    className="absolute top-20 left-1/4 w-96 h-96 bg-blue-500 rounded-full blur-3xl opacity-10"
    animate={{ scale: [1, 1.2, 1] }}
    transition={{ duration: 6, repeat: Infinity }}
  />
  <motion.div
    className="absolute bottom-20 right-1/4 w-96 h-96 bg-purple-500 rounded-full blur-3xl opacity-10"
  ...
  >
    ...
    <motion.h1
      className="text-5xl lg:text-7xl font-bold mb-8 leading-tight bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent"
    ...
    <motion.p
      className="text-2xl lg:text-3xl font-light italic mb-8 text-blue-100"
    ...
    >
      ...
      <motion.section
  className="py-24 px-12 lg:px-24 bg-gradient-to-b from-gray-900 via-black to-gray-900 relative overflow-hidden"
  initial={{ opacity: 0 }}
...
>
  <div className="max-w-7xl mx-auto relative">
    ...
    <motion.h2
      className="text-4xl font-bold text-center mb-16 relative z-10 text-white"
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
      ...
      {/* Challenges Panel */}
      <motion.div
        className="bg-gradient-to-br from-red-900/20 to-red-950/20 border border-red-500/30 p-10 rounded-lg"
      ...
      {/* Solutions Panel */}
      <motion.div
        className="bg-gradient-to-br from-blue-900/20 to-blue-950/20 border border-blue-500/30 p-10 rounded-lg"
        initial={{ opacity: 0, x: 80 }}
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
...
>
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    >
      ...
      <motion.section
  className="py-24 px-12 lg:px-24 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden"
  initial={{ opacity: 0 }}
  whileInView={{ opacity: 1 }}
  viewport={{ once: true }}
  transition={{ duration: 1 }}
>
  {/* Subtle Animated Background Glow */}
  <motion.div
    className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-3xl"
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    >
      {[
        ...
        <motion.div
          key={idx}
          className="p-6 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-lg text-center hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 transition-all"
          variants={{
        ...
        >
          <motion.p
            className="text-xs text-blue-400 font-bold uppercase mb-2"
...
>
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    >
      {[
        ...
        >
          <div className="flex items-start justify-between mb-6">
            ...
            <motion.span
              className="bg-blue-500/20 text-blue-400 px-4 py-1 text-sm font-bold rounded-full whitespace-nowrap ml-4"
              initial={{ scale: 0.9 }}
              whileInView={{ scale: 1 }}
              transition={{ type: "spring", stiffness: 200 }}
            >
     ...
     <motion.section
  className="py-24 px-12 lg:px-24 bg-gradient-to-r from-blue-950 to-purple-950 relative overflow-hidden"
  initial={{ opacity: 0 }}
  whileInView={{ opacity: 1 }}
  viewport={{ once: true }}
  transition={{ duration: 1 }}
>
  {/* Animated Background Glow */}
  <motion.div
    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-blue-500/10 rounded-full blur-3xl"
