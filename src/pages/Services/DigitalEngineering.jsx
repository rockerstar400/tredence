      ...
      {[
        {
          ...
          techs: [
            'TypeScript','Python','Java','Go','React','Vue.js','Node.js','FastAPI',
          ],
        },
        {
          category: 'Cloud Platforms & Services',
          techs: [
            'AWS','Google Cloud','Azure','Kubernetes','Serverless','Managed Databases',
          ],
        },
        {
          category: 'DevOps & Infrastructure',
          techs: [
            'Docker','Kubernetes','Terraform','GitHub Actions','Jenkins','Prometheus',
          ],
        },
        {
          category: 'Data & Streaming',
          techs: [
            'PostgreSQL','MongoDB','Redis','Kafka','ElasticSearch','TimescaleDB',
          ],
        },
      ].map((stack, idx) => (
        <motion.div
