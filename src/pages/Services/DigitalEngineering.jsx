      ...
      <section className="relative h-[80vh] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-200 max-w-3xl mx-auto">
            We engineer digital products and platforms that scale. From
            microservices architecture to mobile applications, we combine design
            thinking, engineering rigor, and cloud-native practices to deliver
            products that customers love and businesses can scale.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group p-8 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg hover:border-orange-300 hover:shadow-xl transition-all hover:glow duration-300"
              >
              ...
              <div key={idx}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {stack.techs.map((tech, i) => (
                    <div
                      key={i}
                      className="p-4 bg-white border border-gray-200 rounded-lg text-center hover:border-orange-300 hover:shadow-lg transition-all group"
                    >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <div key={idx} className="border-l-4 border-orange-600 pl-8">
          ...
          <div className="bg-[#fff1ea] shadow-2xl p-10 lg:p-16 flex flex-col lg:flex-row gap-12 rounded-lg">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-700 text-lg mb-8">
                Let's discuss your engineering challenges and explore how we can
                help you build, scale, and maintain world-class digital
                products.
              </p>
            </div>
            <div className="lg:w-1/2">
              <form className="space-y-6">
                ...
                />
                <textarea
                  placeholder="Describe your engineering challenges"
                  rows="3"
