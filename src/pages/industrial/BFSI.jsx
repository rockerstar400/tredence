      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24 max-w-7xl">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            ...
            <span className="text-orange-500">BFSI</span>
          </nav>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Turn Enterprise{' '}
              <span className="text-orange-600">data into business impact</span>{' '}
              with AI-powered intelligence
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence helps BFSI organizations build resilient risk
                frameworks, agile treasury operations, and faster product
                innovation using AI and advanced analytics.
              </p>
              <p>
                With data modernization, digital twins, and predictive modeling,
                we bring together fragmented operational, clinical, and research
                data to create a unified intelligence layer that improves
                outcomes and drives competitive advantage.
              </p>
            </div>
          </div>
        </div>
