...
import { Star, ChevronRight, ChevronLeft , ChevronDown, ChevronUp,  } from 'lucide-react';
...
const Healthcare = () => {
  ...
  return (
    <div className="font-sans antialiased">
      ...
      <section className="relative h-[80vh] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-90">
            <span>Home</span> / <span>Industry</span> / <span className="text-orange-500">Healthcare</span>
          </nav>
      ...
      {/* --- Section 2: Modernize Data (Image + Text) --- */}
      <section className="py-24 px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          
          {/* Left: Futuristic Doctor Image */}
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              {/* Floating Icons (Simplified for UI) */}
              ...
              {/* Floating Icon Boxes */}
              <div className="absolute top-10 -left-6 bg-orange-600 p-4 text-white text-2xl shadow-lg">💓</div>
              <div className="absolute top-20 -right-6 bg-orange-600 p-4 text-white text-2xl shadow-lg">📋</div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Modernize <span className="text-orange-600">data & optimize care</span> in healthcare
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Tredence helps leading healthcare organizations move toward value-based care by modernizing data and analytics ecosystems.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed">
              By bringing data together using advanced data engineering, AI/ML, and healthcare analytics, we deliver smarter insights and personalized experiences that support a member-first healthcare ecosystem built for the future.
            </p>
          </div>
        </div>
      </section>

      {/* --- Section 3: Reusable Logo Slider --- */}
      <LogoSlider 
        title="Meet the" 
