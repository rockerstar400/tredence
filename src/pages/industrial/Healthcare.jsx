...
const Healthcare = () => {
  ...
  const awardLogos = [
    ...
    // 'https://images.unsplash.com/photo-1581093588401-22f5f8a7e3c6?auto=format&fit=crop&w=800&q=80',
  ];
        ...
        <div className="px-6 lg:px-24">
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.9 }}
              className="text-3xl lg:text-5xl font-light italic"
            >
      ...
      <section className="py-28 px-12 lg:px-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          >
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              <motion.div
                ...
                className="absolute inset-0 border-[3px] border-orange-500/30 rounded-full scale-110"
              />
              ...
              {['💓', '📋', '🧬'].map((icon, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -6 }}
                  className={`absolute bg-orange-600 p-4 text-white text-2xl shadow-lg ${
                    idx === 0
                      ? 'top-10 -left-6'
                      : idx === 1
                        ? 'top-20 -right-6'
          ...
          >
            ...
            >
              Modernize{' '}
              <span className="text-orange-600">data & optimize care</span> in
              healthcare
            </motion.h2>
            ...
            >
              Sigma helps leading healthcare organizations move toward
            ...
            >
              By bringing data together using advanced data engineering, AI/ML,
              and healthcare analytics, we deliver smarter insights and
              personalized experiences that support a member-first healthcare
              ecosystem built for the future.
            </motion.p>
          </motion.div>
        </div>
      </section>
