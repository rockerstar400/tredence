        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              {/* Floating Icon Boxes */}
              <div className="absolute top-10 -left-6 bg-orange-600 p-4 text-white text-2xl shadow-lg">
                💓
              </div>
              <div className="absolute top-20 -right-6 bg-orange-600 p-4 text-white text-2xl shadow-lg">
                📋
              </div>
