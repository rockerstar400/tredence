...
const CPG = () => {
  ...
  // Award Logos (Aap local path se replace kar sakte hain)
  const awardLogos = [
  ...
  return (
    <div className="font-sans antialiased text-gray-900">
      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24 max-w-6xl">
          {/* Breadcrumbs */}
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            ...
            <span className="text-orange-500">CPG</span>
          </nav>

          <h1 className="text-5xl lg:text-7xl font-bold mb-8 leading-[1.1]">
            Accelerate CPG <br /> Impact With AI-First Innovation
          </h1>
          <p className="text-3xl lg:text-5xl font-light italic opacity-90">
            Industrialize AI at Scale across CPG Operations
          </p>
        </div>
      </section>

      {/* --- Section 2: Powering CPG Decisions --- */}
      <section className="py-24 px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          {/* Left: Couple with Groceries & Tech Accents */}
          <div className="lg:w-1/2 relative">
            {/* Background Orange 'T' Graphic */}
            <div className="absolute -top-10 -left-5 w-64 h-24 bg-orange-600 -z-0 transform -skew-x-12 opacity-90"></div>

            <div className="relative z-10 flex justify-center items-center">
              <img
                src="https://img.freepik.com/free-photo/happy-young-couple-walking-out-supermarket-with-grocery-bags_23-2148286025.jpg"
                alt="CPG Consumers"
              ...
              {/* Floating Tech Icons */}
              <div className="absolute top-1/4 -left-8 bg-orange-600 p-4 text-white text-2xl shadow-lg">
                🛒
              </div>
              <div className="absolute top-10 right-0 bg-orange-600 p-4 text-white text-2xl shadow-lg">
                📈
              </div>
              <div className="absolute bottom-5 left-1/4 bg-orange-600 p-4 text-white text-2xl shadow-lg">
                🤝
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Powering <span className="text-orange-600">CPG Decisions</span>{' '}
              Through AI Advantage
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence powers the data and AI strategies for the world's
                leading consumer brands, including 8 of the top 10 CPG
                companies. We help enterprises strengthen demand forecasting,
                optimize supply planning, and unlock revenue growth through
                AI-driven trade promotion and pricing strategies.
              </p>
              <p>
                Our deep CPG domain expertise, combined with advanced data
                engineering and data science, enables brands to harmonize
                fragmented data, accelerate RGM programs, and turn enterprise
                insights into actions that boost market share, margins, and
