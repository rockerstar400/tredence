      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl lg:text-7xl font-bold mb-8 leading-[1.1]"
          >
          ...
          >
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              <motion.div
                ...
                className="absolute top-1/4 -left-8 bg-orange-600 p-4 text-white text-2xl shadow-lg"
              >
                🛒
              </motion.div>
              ...
              <motion.div
                ...
                transition={{ duration: 6, repeat: Infinity }}
                className="absolute bottom-5 left-1/4 bg-orange-600 p-4 text-white text-2xl shadow-lg"
              >
                🤝
              </motion.div>
            </div>
