      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24 max-w-6xl">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            <span>Home</span> / <span>Industry</span> / <span className="text-orange-500">CPG</span>
          </nav>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              <div className="absolute top-10 right-0 bg-orange-600 p-4 text-white text-2xl shadow-lg">📈</div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Powering <span className="text-orange-600">CPG Decisions</span> Through AI Advantage
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence powers the data and AI strategies for the world's leading consumer brands, including 8 of the top 10 CPG companies. 
                We help enterprises strengthen demand forecasting, optimize supply planning, and unlock revenue growth through AI-driven trade promotion and pricing strategies.
              </p>
              <p>
                Our deep CPG domain expertise, combined with advanced data engineering and data science, enables brands to harmonize fragmented data, accelerate RGM programs, and turn enterprise insights into actions that boost market share, margins, and supply chain resilience.
              </p>
            </div>
          </div>
        </div>
