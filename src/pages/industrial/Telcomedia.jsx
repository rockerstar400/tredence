      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="px-6 lg:px-24 max-w-7xl">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            ...
            <span className="text-orange-500">Telco, Media & Technology</span>
          </nav>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Modernize <span className="text-orange-600">data, CX & ops</span>{' '}
              <br /> for telco, media and tech
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence helps leading telecom, media, and tech (TMT) companies
                modernize their data assets, unify enterprise insights, and
                scale AI adoption.
              </p>
              <p>
                From building AI-powered Customer 360 platforms to democratizing
                data access, we enable businesses to drive personalized
                experiences and enterprise-wide growth, turning AI disruption
