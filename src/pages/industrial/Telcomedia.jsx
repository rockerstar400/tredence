...
const Telcomedia = () => {
  ...
  // Award Logos (Aapne jo local imports setup kiye hain wahi use karein)
  const awardLogos = [
  logo,
  logo
  ];
  ...
  return (
    <div className="font-sans antialiased text-gray-900">
      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        {/* Global Network/Tech Background */}
        <div 
        ...
        <div className="px-6 lg:px-24 max-w-7xl">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            <span>Home</span> / <span>Industry</span> / <span className="text-orange-500">Telco, Media & Technology</span>
          </nav>
          ...
          <p className="text-3xl lg:text-5xl font-light italic opacity-90 leading-snug">
            For Telco, Media & Tech Companies
          </p>
        </div>
      </section>

      {/* --- Section 2: Modernize Data, CX & Ops --- */}
      <section className="py-24 px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          
          {/* Left: Professional Duo with T-Graphic and Telco Icons */}
          <div className="lg:w-1/2 relative">
            {/* Orange T Background Shape */}
            <div className="absolute -top-10 -left-5 w-64 h-32 bg-orange-600 -z-0 transform -skew-x-12 opacity-90"></div>
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              {/* Telco Specific Icons (Floating) */}
              <div className="absolute top-1/4 -left-10 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="Telecom Tower">📡</div>
              <div className="absolute top-10 right-0 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="Media & Entertainment">🎮</div>
              <div className="absolute bottom-5 right-1/4 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="AI & Tech">⚙️</div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Modernize <span className="text-orange-600">data, CX & ops</span> <br /> for telco, media and tech
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence helps leading telecom, media, and tech (TMT) companies modernize their data assets, unify enterprise insights, and scale AI adoption.
              </p>
              <p>
                From building AI-powered Customer 360 platforms to democratizing data access, we enable businesses to drive personalized experiences and enterprise-wide growth, turning AI disruption into a lasting advantage.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* --- Section 3: Logo Scroll (Reusable) --- */}
      <LogoSlider 
        title="Meet the undisputed" 
        highlightText="TMT analytics" 
