    ...
    <div className="font-sans antialiased text-gray-900">
      ...
      <section className="relative h-[85vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=2000')` }}
        >
        ...
        <div className="px-6 lg:px-24 max-w-7xl">
          ...
          <nav className="mb-12 text-sm font-medium flex justify-center gap-2 opacity-80 uppercase tracking-widest">
            <span>Home</span> / <span>Industry</span> / <span className="text-orange-500">Travel and Hospitality</span>
          </nav>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative z-10 flex justify-center items-center">
              ...
              <div className="absolute top-1/4 -left-10 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="Travel / Luggage">🧳</div>
              <div className="absolute top-10 right-0 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="Hospitality / Hotel">🏨</div>
              <div className="absolute bottom-5 right-1/4 bg-orange-600 p-4 text-white text-2xl shadow-lg" title="Dining / Experience">🍽️</div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              Modernize <span className="text-orange-600">data & personalize journeys</span> across travel and hospitality
            </h2>
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                Tredence helps leading travel & hospitality (T&H) companies modernize their data and analytics landscape to manage guest experiences end-to-end.
              </p>
              <p>
                By unifying customer insights and enabling AI-powered personalization, we help brands unlock new monetization opportunities, improve retention, and sustain double-digit revenue growth through smarter, cross-channel engagement.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-12 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-3/4 space-y-4">
            {[
              { q: "How can AI improve guest personalization in hotels?", a: "AI analyzes guest preferences, past stays, and feedback to offer personalized room settings, dining recommendations, and targeted loyalty offers in real-time." },
              { q: "What is the role of predictive analytics in airline pricing?", a: "Predictive models help airlines optimize dynamic pricing based on demand trends, competitor rates, and even local events to maximize load factors and revenue." },
              { q: "How does Tredence help with customer loyalty programs?", a: "We unify fragmented data across bookings, apps, and partner networks to create a 360-degree view, helping brands design 'hyper-personalized' rewards that drive long-term retention." }
            ].map((faq, idx) => (
              <div key={idx} className="border-b border-gray-200">
                ...
                {activeFaq === idx && <div className="pb-8 text-gray-600 text-sm leading-relaxed animate-fadeIn">{faq.a}</div>}
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-[#fff1ea] shadow-2xl p-10 lg:p-16 flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2">
              <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-12">
                Demand more out of AI. Talk to T&H experts born and bred in full-stack AI.
              </h2>
