  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-10 -left-5 w-64 h-32 bg-orange-600 -z-0 transform -skew-x-12 origin-left opacity-95"
      />
    ...
    >
      ...
      >
        <p>
          Sigma helps leading travel & hospitality (T&H) companies
